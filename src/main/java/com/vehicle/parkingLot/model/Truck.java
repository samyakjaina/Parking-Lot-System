...
public class Truck implements Vehicle {
	...
	public Truck(String regNumber, String phoneNumber) {
		super();
	...
	public String toString() {
		return "Truck [id=" + id + ", regNumber=" + regNumber + ", phoneNumber=" + phoneNumber + ", type=" + type
				+ ", timeRate=" + rate + ", vehicleRate=" + vehicleRate + ", allocatedTime=" + allocatedTime + "]";
	}
